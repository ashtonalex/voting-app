...
export async function POST(request: NextRequest) {
  try {
    ...
    const defaultHash = "$2a$12$eT/O.rISJtd4H7kD9rFefOCGvCohNbz07FThkGgEcJMTRfAR5.gge"
    ...
    const tests = {
      ...
      password: {
        ...
        bytes: Array.from(password || "").map(c => c.charCodeAt(0)),
      },
      ...
      hashes: {
        ...
        helper: {
          ...
          isValid: helperHash ? await bcrypt.compare(password, helperHash) : false,
        },
        default: {
          hash: defaultHash,
      ...
      freshTest: {
        ...
        isValid: await bcrypt.compare("admin123", await bcrypt.hash("admin123", 12)),
      }
    }
